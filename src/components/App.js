  ...
  return (
    <>
      ...
      <Container>      
        ...
        <p><i>Your Balance : {accountBalance} </i></p>
              ...
              <Card.Body>
                ...
                <form 
                  ...
                  <div className='form-group mb-2'>
                    <label htmlFor="price" className="sr-only">Ticket Price</label>
                    <input
                      id='price'
                      step="0.01"
                      type='number'
        ...
        <Card>
          <Card.Body>
            ...
            <Card.Text>
              Please buy the ticket with <b> {ticketPrice} ETH</b> and be a winner!
            </Card.Text>
            {
